...
const data = {
    ...
    Banner: {
        ...
        data: [
            ...
            {
                src: 'https://lh3.googleusercontent.com/SqIiJ6AAb5F85W26goQH9Zw-skBHY12PePmn8q2lGM8gY8OD12JJTYGZJN7BMwJa-w87hB9qzRour0Oz2UQ=w800-rw',
                text: '左右型',
                textEn: 'Tab menu',
                uid: 5,
            },
...
configDataFile = path.join("data", "data_template_config.json");
fs.writeFile(configDataFile, JSON.stringify(data), function (err) {
    if (err) {
