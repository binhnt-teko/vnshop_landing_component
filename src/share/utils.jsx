...
import tempData from '../template/element/template.config';
...
export const getDataSourceValue = (id, templateData, parent) => {
  ...
  if (parent) {
    ...
    console.log("binhnt: getDataSourceValue " + cid);
    tt = {
      [parent[0]]: {
